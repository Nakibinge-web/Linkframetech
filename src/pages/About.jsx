  ...
  return (
    <>
      ...
      <section className="section-padding">
        <div className="container-max">
          <div ref={storyRef} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className={`fade-up ${storyInView ? 'in-view' : ''} text-center lg:text-left`}>
              <h2 className="heading-md text-text-light mb-6">Our story</h2>
              <p className="text-body mb-4 mx-auto lg:mx-0">
            ...
            <div className={`fade-up delay-200 ${storyInView ? 'in-view' : ''} text-center lg:text-left`}>
              <h2 className="heading-md text-text-light mb-6">Mission & Vision</h2>
              <div className="flex flex-col gap-6 mx-auto lg:mx-0 max-w-prose">
                <div className="border-l-2 border-brand-orange pl-6 transition-all duration-300 ease-out hover:pl-8 text-left">
                ...
                <div className="border-l-2 border-brand-blue pl-6 transition-all duration-300 ease-out hover:pl-8 text-left">
      ...
      <section className="section-padding bg-white/[0.01]">
        <div className="container-max">
          <div className="max-w-xl mb-16 mx-auto lg:mx-0 text-center lg:text-left">
          ...
          <div ref={valuesRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map(({ title, description }, i) => (
              <div key={title} className={`fade-up delay-${(i + 1) * 100} ${valuesInView ? 'in-view' : ''} group text-center lg:text-left`}>
                <span className="font-fraunces text-5xl font-bold text-brand-orange/15 group-hover:text-brand-orange/30 transition-colors duration-300 block">
                  0{i + 1}
                </span>
