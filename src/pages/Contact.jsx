    ...
    <>
      ...
      <section className="relative min-h-[50vh] flex items-end overflow-hidden">
        ...
        <div ref={heroRef} className="container-max section-padding relative z-10 pt-40">
          ...
          <h1 className={`fade-up delay-100 ${heroInView ? 'in-view' : ''} heading-xl text-text-light max-w-2xl`}>Let's start a conversation.</h1>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-max">
          <div ref={formRef} className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            {/* Form */}
            <form onSubmit={handleSubmit} className={`fade-up ${formInView ? 'in-view' : ''} lg:col-span-3 flex flex-col gap-6`}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label htmlFor="name" className="text-text-muted text-sm">Name</label>
                  <input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-text-muted text-sm">Email</label>
                  <input
                    id="email"
                    name="email"
                    type="email"
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="message" className="text-text-muted text-sm">Message</label>
                <textarea
                  id="message"
                  name="message"
                  required
            ...
            {/* Info */}
            <div className={`fade-up delay-200 ${formInView ? 'in-view' : ''} lg:col-span-2 flex flex-col gap-10`}>
              <div>
